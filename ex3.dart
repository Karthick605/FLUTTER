  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: const Color.fromARGB(255, 204, 15, 15),
      ),
      body: s.isEmpty
          ...
          : ListView(
              children: s.asMap().entries.map((e) {
                ...
                return Card(
                  ...
                  color: const Color.fromARGB(255, 11, 168, 207),
                  child: ExpansionTile(
                    title: Text(
                      x["name"]!,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: IconButton(
                          icon: const Icon(Icons.delete, color: Color.fromARGB(255, 29, 28, 27)),
                          onPressed: () =>
